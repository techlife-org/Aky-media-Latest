...
interface SocialMediaLiveBroadcastWithIdProps {
  broadcastId: string
}

export default function SocialMediaLiveBroadcastWithId({ broadcastId }: SocialMediaLiveBroadcastWithIdProps) {
    ...
    return (
      <section className="min-h-screen bg-gradient-to-br from-red-900 via-red-800 to-red-900 flex items-center justify-center p-4">
        <div className="text-center text-white">
          ...
          <p className="text-white/80 text-lg">Checking broadcast {broadcastId.slice(0, 8)}...</p>
        </div>
      </section>
    )
  }
    ...
    return (
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold text-white mb-6">Broadcast Not Found</h2>
          <p className="text-gray-300 text-lg mb-4">
            The broadcast with ID <code className="bg-gray-800 px-3 py-1 rounded text-purple-400 font-mono">{broadcastId}</code> is not currently active.
          </p>
          <p className="text-gray-400 text-lg mb-8">
            The stream may have ended or the link might be incorrect.
          </p>
            ...
            <Card className="shadow-2xl border-0 bg-white/10 backdrop-blur-lg border border-white/20">
              <CardHeader className="text-center bg-gradient-to-r from-red-600 via-red-500 to-red-700 text-white rounded-t-lg p-8">
                ...
                <Badge className="mx-auto bg-white/20 text-white border-white/30 mt-2">
                  Stream ID: {broadcastId.slice(0, 8)}...
                </Badge>
              </CardHeader>
