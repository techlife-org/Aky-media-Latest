            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center mr-4 shadow-2xl">
                    <Music className="w-8 h-8 text-red-800" />
                  </div>
                  <h1 className="text-6xl lg:text-7xl font-bold text-red-800">
                    Audio
                  </h1>
                </div>
