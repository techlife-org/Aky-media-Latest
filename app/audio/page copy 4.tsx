...
export default function AudioPage() {
  ...
  useEffect(() => {
    // This useEffect is for the overall page loading, not individual audio tracks.
  ...
  }, [currentTrack, isRepeating, isPlaying]) // Added isPlaying to dependencies
  ...
  useEffect(() => {
    ...
    if (audio.src !== audioUrl) {
      ...
      // If the previous state was playing, attempt to play the new track
      // The 'canplay' event listener will handle actual playback when ready
      if (isPlaying) {
        audio.play().catch(console.error) // Attempt to play, error handled by general error listener
      }
    }
  }, [currentTrack, mediaPath, isPlaying]) // isPlaying is crucial here
