...
const genreColors = {
  Leadership: "bg-gradient-to-r from-red-100 to-orange-100 text-red-800 border border-red-200",
  Spiritual: "bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 border border-purple-200",
  Campaign: "bg-gradient-to-r from-blue-100 to-red-100 text-blue-800 border border-blue-200",
  Collaboration: "bg-gradient-to-r from-green-100 to-red-100 text-green-800 border border-green-200",
  Governance: "bg-gradient-to-r from-indigo-100 to-red-100 text-indigo-800 border border-indigo-200",
  Unity: "bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-800 border border-yellow-200",
  Progress: "bg-gradient-to-r from-teal-100 to-green-100 text-teal-800 border border-teal-200",
  Awareness: "bg-gradient-to-r from-cyan-100 to-blue-100 text-cyan-800 border border-cyan-200",
  Political: "bg-gradient-to-r from-red-100 to-rose-100 text-red-800 border border-red-200",
  Seasonal: "bg-gradient-to-r from-pink-100 to-rose-100 text-pink-800 border border-pink-200",
  Support: "bg-gradient-to-r from-orange-100 to-red-100 text-orange-800 border border-orange-200",
  Achievement: "bg-gradient-to-r from-emerald-100 to-green-100 text-emerald-800 border border-emerald-200",
  Praise: "bg-gradient-to-r from-violet-100 to-purple-100 text-violet-800 border border-violet-200",
  Reform: "bg-gradient-to-r from-slate-100 to-gray-100 text-slate-800 border border-slate-200",
  Celebration: "bg-gradient-to-r from-amber-100 to-yellow-100 text-amber-800 border border-amber-200",
  Narrative: "bg-gradient-to-r from-rose-100 to-pink-100 text-rose-800 border border-rose-200",
  Prayer: "bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-800 border border-indigo-200",
  Development: "bg-gradient-to-r from-lime-100 to-green-100 text-lime-800 border border-lime-200",
}
